...
const Login = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 max-w-[850px] w-full mx-auto gap-12 my-20">
      <div className="hidden lg:block col-span-1 bg-[url(/login.png)] w-full h-[400px] bg-center rounded-xl"></div>
      <div className="col-span-1">
        <p className="text-heading-2 text-text-heading font-bold mb-2 font-sans">
          Login
        </p>
        <p className="text-text-muted text-smmall mb-8">
