...
const BoxBanner: React.FC<IBannerProps> = ({
  ...
  return (
    <div className="bg-blue-100 p-6 mt-28 rounded-xl flex flex-col md:flex-row items-center mb-4">
      <div className="flex-1">
        ...
        <div className="mt-4 w-[350px] h-[50px] bg-white flex items-center rounded-[30px] bg-brand-third p-2 border ">
